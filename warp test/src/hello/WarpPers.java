...
public final class WarpPers extends Warp {
     ...
     */
    public WarpPers(PerspectiveTransform transform) {
        if (transform == null) {
            throw new IllegalArgumentException(PropertyUtil.getString("com.sun.media.jai.tilecodec","WarpPerspective0"));
        }
    ...
    public Rectangle mapDestRect(Rectangle destRect) {
        if ( destRect == null ) {
            throw new IllegalArgumentException(PropertyUtil.getString("com.sun.media.jai.tilecodec","Generic0"));
        }
